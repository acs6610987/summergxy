...
if(!empty($content)){
	...
	?>
	<div id="gmFlatwall_ID<?php echo $gallery['term_id']; ?>_Container" class="gmFlatwall_Container">
		...
		?><script type="text/javascript">
			...
			jQuery(function(){
				...
				GmediaGallery_<?php echo $gallery['term_id']; ?> = jQuery('#GmediaGallery_<?php echo $gallery['term_id'] ?>').gmFlatwall([content, settings]);
			});
