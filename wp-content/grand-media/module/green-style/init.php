...
if(!empty($content)){
	...
	?>
	<div id="gmGreenStyle_ID<?php echo $gallery['term_id']; ?>_Container" class="gmGreenStyle_Container">
		...
		?><script type="text/javascript">
			...
			jQuery(function(){
				...
				GmediaGallery_<?php echo $gallery['term_id']; ?> = jQuery('#GmediaGallery_<?php echo $gallery['term_id'] ?>').gmGreenStyle([content, settings]);
			});
