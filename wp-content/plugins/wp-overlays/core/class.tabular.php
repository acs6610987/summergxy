...
if ( ! class_exists( 'WP_List_Table_Helper' ) ) {
	 ...
	 */
		...
		<h4 class="alert alert-info"><?php _e( 'Manage '.ucwords( $this->plural_label ), $this->textdomain );?><a style='float:right' target='_blank' href='http://codecanyon.net/downloads'>Rate Me - <img src='<?php echo WOP_IMAGES ?>rating.png' /></a></h4>
	</div>
