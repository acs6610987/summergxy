...
if ( ! class_exists( 'FlipperCode_HTML_Markup' ) ) {
	...
	class FlipperCode_HTML_Markup {
		 ...
		 * @var Array
		 */
		private $form_elements = array( 'text','checkbox','multiple_checkbox','radio','submit','button','select', 'hidden', 'wp_editor', 'html', 'datalist','textarea' , 'file' , 'div' , 'blockquote','html' , 'image','group','table', 'message', 'anchor', 'image_picker', 'radio_slider' );
		/**
		 * Attributes Allowed
		 * @var Array
		 */
		...
		public function get_manage_url() {
			return "<a style='float:right' target='_blank' href='http://codecanyon.net/downloads'>Rate Me - <img src='".WOP_IMAGES."rating.png' /></a>";
		}
		/**
